...
<img src="Images/04_add_place.png" width="300" alt="Add place form showing Place Name, Trip Name and Location Details sections">
...
A **trip picker card** appears at the top of the map. Tap it and choose a trip from the list. The map zooms to fit all stops on the selected trip.
...
<img src="Images/09_shared_albums.png" width="300" alt="Shared album picker with clustering radius settings and available albums">
